...
const Card = ({ linesByIdWithCards, setClickedId, setIsVisibleDel, title, text, link, color, setColor, beginX, beginY, endX, endY, id, cardMaxWidth, setTitle, setText, setLink }) => {
